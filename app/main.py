...
app.include_router(auth_router)  # NOVO - Rotas de autenticação (/auth/*)
app.include_router(users_router)  # NOVO - Rotas de gestão de usuários (/users/*)
